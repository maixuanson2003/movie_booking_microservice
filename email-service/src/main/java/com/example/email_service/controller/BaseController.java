...
import com.example.email_service.service.BaseService;
import com.example.email_service.sharedLogic.dto.ApiResponse;
import com.example.email_service.exception.BadRequestException;
import com.example.email_service.sharedLogic.mapper.BaseMapper;
...
public abstract class BaseController<E, ID, D> {
    ...
    /** Apply the URL id so an update cannot target a different record from the body. */
